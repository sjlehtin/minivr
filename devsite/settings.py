...
DATABASES = {
    'default': {
        ...
        'NAME': 'minivr',                # Or path to database file if using sqlite3.
        'USER': 'minivr',                # Not used with sqlite3.
        'PASSWORD': 'minivr345',         # Not used with sqlite3.
...
SECRET_KEY = '2&o)&*ze+dio0329-49fq6@cw1y9y^y2d_gzky9716khlxl7bx'
...
TEMPLATE_DIRS = (
    ...
    # Assume running manage.py under development directory.
    os.getcwd() + '/templates'
)
